...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./Users/quentin/Desktop/Agile/wiki_creativ/wiki_code/wiki_laravel/public/storage' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.links./Users/quentin/Desktop/Agile/wiki_creativ/wiki_code/wiki_laravel/public/storage','logging.default',
...
'web','api',);
        registerArgumentsSet('routes', 'home','roles.create','roles.edit','roles.destroy',
'roles.insert','roles.update','subscribe','subscribe.store','subscribe.process',
'register.complete','register.finalization','admin','admin.register','admin.create-user',
'login','logout','password.request','password.email',
'password.reset','password.update','credentials.index','credentials.create','credentials.store',
'credentials.edit','credentials.update','credentials.destroy','categories.index','categories.create',
'categories.store','categories.edit','categories.update','categories.destroy','documents.index',
'documents.create','documents.store','documents.byCategory','documents.show','documents.edit',
'documents.update','storage.local',);
        registerArgumentsSet('views', 
'admin_create_user_invitation','admin_index','auth.forgot-password','auth.login','auth.reset-password',
'category.category-list','category.create-category-form','category.edit-category-form','components.role-list','components.user_request_list',
'create-credentials','create-role-form','credentials','documents.by-category','documents.create-form',
'documents.document','documents.document-list','documents.edit-form','edit-credentials','emails.registration_link',
'emails.rejection','layouts.app','update-role-form','user_form_first_step','user_form_password_step',
