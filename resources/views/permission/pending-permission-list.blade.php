...
@section('content')
    ...
    <div class="container mx-auto p-6">
        <h1 class="text-xl font-semibold text-[#126C83] text-center mb-6">Liste des permissions en attentes</h1>
        <a href="{{ route('admin.permissions') }}" class="bg-[#126C83] text-white px-4 py-2 rounded hover:bg-[#35A5A7] mb-4 inline-block">Toutes les permissions</a>
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($permissions as $permission)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-gray-700">{{ Auth::user($permission->author)->name }}</td>
