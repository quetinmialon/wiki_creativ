<form method="POST" action="{{ route('admin.permissions.search') }}" class="flex items-center p-4 bg-white shadow-md rounded-md">
    @csrf
    <div class="relative w-full">
        <input type="text" name="query" placeholder="Rechercher des permissions..."
