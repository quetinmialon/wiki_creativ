...
<div class="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
    <h1 class="text-xl font-semibold text-[#126C83] mb-6 text-center">Modifier le Document</h1>
    ...
    <form action="{{ route('documents.update', $document->id) }}" method="POST" class="space-y-6">
        ...
        <div id="editor" class="border rounded p-2 min-h-64">{!! old('content', $document->content) !!}</div>
        ...
        <!-- Catégories -->
        <div id="categoriesDiv" class="mt-6">
